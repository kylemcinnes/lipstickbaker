    ...
    <>
      ...
      <main className="pt-16 lg:pt-20">
        <div className="mx-auto max-w-3xl px-4 py-12 space-y-6">
          ...
          <p>Boxes include your choice of 3 flavours for $50. Wedding cakes over $480 include a mini cake sample box and will be credited the $50 towards their final balance!</p>

          <h3 className="text-xl font-semibold mt-6">Allergens</h3>
          <p>Although most our cakes do not contain nuts, they are used on occasion in the kitchen per the request of other customers!</p>

          <h3 className="text-xl font-semibold mt-6">Vegan + Gluten free</h3>
